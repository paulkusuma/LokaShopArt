...
<head>
    ...
    <script src="{{ asset('js/scriptLanding.js') }}"></script>
</head>
<body>
    <!--Header-->
    <header id="header" class="parallax-window">
      ...
      <div class="header-slider">
        <img src="{{ asset('storage/gambar/gambarHeader1.jpg') }}" alt="Slide 1">
        <img src="{{ asset('storage/gambar/gambarHeader2.jpg') }}" alt="Slide 1">
        <img src="{{ asset('storage/gambar/gambarHeader3.jpg') }}" alt="Slide 1">
      </div>
      <nav>
        <h1 class="Logo">
          <a href="/">LokaArt</a>
        </h1>
        <a href="/" class="btnSignup">Mulai Belanja</a>
      </nav>
    ...
    <section id="about">
      <div class="aboutcontainer">
        <div class="image">
          <div class="image-box">
            <img src="{{ asset('storage/gambar/gelas.jpg') }}" alt="image">
            <h2 class="Jdl">Gelas</h2>
          </div>
            <div class="image-box">
            <img src="{{ asset('storage/gambar/Guci.jpg') }}" alt="image">
            <h2 class="Jdl">Guci</h2>
          </div>
            <div class="image-box">
            <img src="{{ asset('storage/gambar/patung.jpg') }}" alt="image">
            <h2 class="Jdl">Patung</h2>
          </div>
            <div class="image-box">
            <img src="{{ asset('storage/gambar/tas.jpg') }}" alt="image">
            <h2 class="Jdl">Tas</h2>
          </div>
        </div>
        <div class="aboutinfo">
